...
const AdminCreate = ({ categories }) => {
  ...
  const [inputs, setInputs] = useState({
    ...
    desc: "",
    price: 0,
    categoryId: "", // Changed from catTitle to categoryId
  });
  ...
  return (
    <form
      className="w-96 p-4  mx-auto text-neutral-200 xs:w-80 py-8 pt-4"
    ...
    >
      ...
      <button
        type="submit"
        className=" bg-neutral-100 mt-2 p-2 rounded text-center
      cursor-pointer  w-full text-blackk transition hover:bg-neutral-200"
      >
        {loading ? (
          
          <div className="w-full justify-center items-center">
          <div className="animate-spin rounded-full h-5 w-5 border-b-2 mx-auto border-gray-900"></div> 
                   </div>
        ) : (
"Submit"
